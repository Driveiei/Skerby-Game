...
public class Block {
	...
	private Image blockDownLeft = (new ImageIcon(this.getClass().getResource("/Images/StateLV1/FloorDownLeft.png"))).getImage();
	private Image blockDownRight = (new ImageIcon(this.getClass().getResource("/Images/StateLV1/FloorDownRight.png"))).getImage();
	private Image blockInside = (new ImageIcon(this.getClass().getResource("/Images/StateLV1/FloorInside.png"))).getImage();
	private Image blockLeft = (new ImageIcon(this.getClass().getResource("/Images/StateLV1/FloorLeft.png"))).getImage();
	private Image blockRight = (new ImageIcon(this.getClass().getResource("/Images/StateLV1/FloorRight.png"))).getImage();
	private Image blockTopLeft = (new ImageIcon(this.getClass().getResource("/Images/StateLV1/FloorTopLeft.png"))).getImage();
	private Image blockTopRight = (new ImageIcon(this.getClass().getResource("/Images/StateLV1/FloorTopRight.png"))).getImage();
