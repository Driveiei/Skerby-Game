...
public class EnterYourName extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		// jLabel1.setIcon(new
		// javax.swing.ImageIcon(getClass().getResource("/Images/Background/YouDie.png")));
		// // NOI18N
		jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource(
				"/Images/Background/EnterYourName.png"))); // NOI18N
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		if (jTextField1.getText().length() < 12) {
			...
			JOptionPane.showMessageDialog(null,
					"Character name should below 12 alphabetc haracters.");
		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(EnterYourName.class.getName())
